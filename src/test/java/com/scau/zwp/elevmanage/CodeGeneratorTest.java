...
public class CodeGeneratorTest {
    @Test
    void generate() {
        String url = "jdbc:mysql://localhost:3306/elevmanage?characterEncoding=UTF-8&useUnicode=true&serverTimezone=Asia/Shanghai";
        ...
        FastAutoGenerator.create(url, username, password)
                ...
                .globalConfig(builder -> {
                    builder.author("KinnakaIhou") // 设置作者名
...
//                            .fileOverride()   //覆盖之前的文件
                ...
                .packageConfig(builder -> {
                    builder.parent("com.scau.zwp.elevmanage") // 设置父包名
