...
public interface ManufacturerService extends IService<Manufacturer> {
     ...
     * @return 实例对象
     */
    R<Manufacturer> queryById(Integer id);
     ...
     * @return
     */
    Page<Manufacturer> paginQuery(Manufacturer manufacturer, Integer current, Integer size);
     ...
     * @return 实例对象
     */
    R<Boolean> insert(Manufacturer manufacturer);
     ...
     * @return 实例对象
     */
    R<Boolean> update(Manufacturer manufacturer);
